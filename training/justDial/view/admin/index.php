                    ...
                    <div class="col-4 ">
                        ...
                        <div class="card text-dark rounded shadow my-5 py-5">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="display-3 fw-bold text-center text-danger"><?php echo $serviceCount; ?></h4>
                    ...
                    <div class="col-4">
                        ...
                        <div class="card text-dark rounded shadow my-5 py-5">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="display-3 fw-bold text-center text-danger"><?php echo $providerCount; ?></h4>
                    ...
                    <div class="col-4">
                        ...
                        <div class="card text-dark rounded shadow my-5 py-5">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="display-3 fw-bold text-center text-danger"><?php echo $aProviderCount; ?></h4>
