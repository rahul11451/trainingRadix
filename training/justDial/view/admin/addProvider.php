                            ...
                            <form method="POST" enctype="multipart/form-data" id="addProviderForm">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="email" name="email" id="" class="form-control border border-dark border-1" value="<?php if (isset($id)) {
                                                                                                                                            echo $editAr[0]['sEmail'];
                                                                                                                                        } ?>" placeholder="Email">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="tel" name="phoneNumber" id="" placeholder="Phone Number" class="form-control border border-dark border-1" value="<?php if (isset($id)) {
                                                                                                                                                                            echo $editAr[0]['nPhoneNumber'];
                                                                                                                                                                        } ?>">
                                ...
                                <div class="row mb-4">
                                    <div class="col form-group">
                                        ...
                                        <textarea name="address" placeholder="Address" id="" class="form-control border border-dark border-1" cols="30" rows="5"><?php if (isset($id)) {
                                                                                                                                                                        echo $editAr[0]['sAddress'];
                                                                                                                                                                    } ?></textarea>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" name="city" id="" placeholder="city" class="form-control border border-dark border-1" value="<?php if (isset($id)) {
                                                                                                                                                            echo $editAr[0]['sCity'];
                                                                                                                                                        } ?>">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" name="pincode" id="" placeholder="Pincode" class="form-control border border-dark border-1" value="<?php if (isset($id)) {
                                                                                                                                                                    echo $editAr[0]['nPincode'];
                                                                                                                                                                } ?>">
