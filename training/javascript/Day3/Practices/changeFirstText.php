        ...
        <div class="col-lg-10 lg:ps-5 pt-4 column10">
            <div class="p-md-5 m-md-5 text-center border border-solid shadow-lg border-primary ">
                <h4 class="mb-5 text-center fw-bold text-decoration-underline text-primary">Use the
                    getElementByTagName method to find the first p element, and change its text.</h4>
                <p id="demo" class="mb-5 text-primary"></p>
            </div>
            <script>
                document.getElementsByTagName('p')[0].innerHTML = "using get elements by tag name";
            </script>
        </div>
    </div>
</div>
