    ...
    <div class="row mb-3">
        ...
        <div class="col-lg-10 lg:ps-5 pt-4 column10">
            <div class="p-md-5 m-md-5 bg-white border rounded shadow-lg border-primary">
                ...
                <h4 class="mb-5 text-center fw-bold text-decoration-underline text-primary">Practical-4 module5
                </h4>
                <p class="mb-5 text-center fw-bold text-decoration-underline text-primary">Using Function call
                    create employee object with field Name, Address and Designation and pass it to function.</p>
                <label for="">
            ...
            <script>
                function myFunction() {
                    var employee = {
                        detail: function() {
                            return "Employee Name: <strong>" + this.Name +
                                "</strong> <br> Employee Address: <strong>" +
                                this.Address + "</strong> <br> Employee Designation: <strong>" +
                                this.Designation + "</strong> <br>";
                        }
                    }
                    var employee1 = {
                    ...
                    document.getElementById('result').innerHTML = employee.detail.call(employee1);
                }
            </script>
        </div>
    </div>
