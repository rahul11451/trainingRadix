...
$result = substr_replace($str, ' server-', strpos($str, 'is')+2, 1);
        ...
        <div class="col-lg-10 lg:ps-5 pt-4 column10">
            <div class="p-md-5 bg-white border rounded shadow-lg border-primary m-5">
                <h4 class="mb-5 text-center fw-bold text-decoration-underline text-primary">
                    Create a program to insert a string at the specified position in a string.
                </h4>
            ...
            <div class="d-sm-flex mx-md-5 justify-content-between mt-5">
                <a href="<?php echo SITE_URL; ?><?php echo $paths ?>arrayString/getLastWord.php" class="text-white">
