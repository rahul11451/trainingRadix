    ...
    <nav class="border navbar navbar-expand-lg bg-primary bg-opacity-50 navbar-dark sticky-top border-start-0 border-end-0 border-primary border-2 shadow-lg">
        ...
        <div class="collapse navbar-collapse" id="menu">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item nav-link lg:pe-5 ps-xl-3 ps-3 ps-sm-2 text-white"> <a href="<?php echo SITE_URL; ?>/main_database/admin/dashboard.php" class=" <?php echo ($_SERVER['PHP_SELF'] == "main_database/admin/dashboard.php" ? "active" : ""); ?> text-decoration-none text-white"> HOME </a></li>



                <li class="nav-item">
                    <a href="<?php echo SITE_URL; ?>/main_database/admin/index.php" class=" <?php echo ($_SERVER['PHP_SELF'] == "main_database/admin/index.php" ? "active" : ""); ?> text-white nav-link lg:pe-5 ps-xl-3 ps-3 ps-sm-2">
                        Login</a>
                </li>
