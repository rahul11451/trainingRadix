        ...
        <form class="" method="POST" enctype="multipart/form-data">
            ...
            <div class=" mb-4">
                ...
                <div class="form-outline flex-fill mb-0">
                    ...
                    <input type="file" id="photo" name="photo" class="mt-3 form-control" value="<?php echo $destination; ?>">
            ...
            <div class=" mb-4 form-control">
                ...
                <div class="flex-fill mb-0 form-check form-switch ">
                    <input class="form-check-input h4 m-1" name="switch" type="checkbox" id="flexSwitchCheckChecked" <?php if ($status == 1) { echo 'checked'; } ?> disabled>
                </div>
            </div>
...
<script src="editUserForm.js"></script>
<?php
