                ...
                <div class="container">
                    <div class="collapse navbar-collapse">
                        <a href="banner.php" class="nav-link text-decoration-none text-white">
                            <img src={pic} alt="logo" class="logo text-white" width="50" />
                        </a>
                        <ul class="navbar-nav">
                    ...
                    <div class="col-12 d-md-none d-sm-block">
                        ...
                        <div class="mt-5" id="mobile_content1">
                            <div class="text-center">
                                <img src={pic} alt="logo" class="logo mb-4" width="100" />
                                ...
                                <img src={feature1} alt="img" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                    <div class="modal-content bg-success opacity-100">
                        <div class="modal-header border-0">
                            <img src={pic} alt="logo" class="" width="50" />
